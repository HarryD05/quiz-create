      ...
      <div id="thp-tables">
        <div id="classes">
          ...
          <div id="class-buttons">
            <button className="btn">See all assignments</button>
            <button className="btn">Set new assignment</button>
        ...
        <div id="students">
          ...
          <div id="student-buttons">
            <button className="btn">See all student's assignments</button>
          </div>
        </div>
      </div>
    </div >
